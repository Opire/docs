...
function generateTipPriceSerie(tipPriceSelected: number, minDefault: number, maxDefault: number, step: number): {
    ...
    <>
      <div>
        ...
        <input
          ...
          style={{ padding: '5px 10px', borderRadius: '5px', border: '1px solid #ccc', color: '#E7CE1B' }}
        />
...
function useDebounceWithMinMax<T>({ max, min, value, delay }: { value: number, delay?: number, min: number, max: number }): number {
