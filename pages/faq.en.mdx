...
<details>
    ...
    <div style={{ marginTop: '10px' }}>
        On the [Projects page](https://app.opire.dev/projects) within Opire, you can see the repositories where our bot is installed, and you can create as many rewards as you'd like within those repositories.

        You can use the search bar to find your favorite project, and if you can't find it, contact the repository's owner to install [our bot](/overview/install-bot).
    </div>
</details>
