...
En Opire, el ciclo de vida de una propina se inicia cuando un usuario decide agradecer los esfuerzos de otro usuario. Este proceso comienza al crear una propina asociada a un Issue o Pull Request (PR) utilizando [nuestros comandos](/es/overview/commands#dar-propina-a-un-usuario).
