...
The total cost to pay will be the sum of the tip amount, plus the **Stripe fee ($0.35 + 5.25%)** and **our fee (10% of the tip)**.

<br/>
<InfoPanel>Our fee is **significantly lower in rewards (4%)**, as we aim to support a collaborative environment where both developers and code owners can thrive in the open-source world.</InfoPanel>
<br/>
