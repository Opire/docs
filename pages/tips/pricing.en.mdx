...
<InfoPanel>**Developers receive 100% of the tip.** Associated costs are charged on top of the tip amount, resulting in the final price to pay.</InfoPanel>

<br/>

## Payment Method

Opire uses Stripe as its payment platform. Therefore, you can pay with any payment methods that Stripe provides.
...
The total cost to pay will be the sum of the tip amount, along with the **Stripe fee ($0.35 + 5.25%)** and **our fee (20% of the tip)**.
