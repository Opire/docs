...
<details>
    ...
    <div style={{ marginTop: '10px' }}>
        Sur la [page Projets](https://app.opire.dev/projects) dans Opire, vous pouvez voir les dépôts où notre bot est installée, et vous pouvez créer autant de récompenses que vous le souhaitez dans ces dépôts.

        Vous pouvez utiliser la barre de recherche pour trouver votre projet préféré, et si vous ne le trouvez pas, contactez le propriétaire du dépôt pour installer [notre bot](/overview/install-bot).
    </div>
</details>
