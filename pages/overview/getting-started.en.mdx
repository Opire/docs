...
### Set up the organization's Stripe account

<DimmedText>If someone external to your project creates rewards and a programmer claims them, you will be elegible for receive a [% of the reward](/rewards/pricing#percentage-for-code-owner) as acknowledgment for your contribution as the code owner.</DimmedText>
<br/><br/>
<DimmedText>In order to access this payment through Opire, it is **essential** to complete the setup of your organization's payment platform. Any organization member can navigate to the [settings page](https://app.opire.dev/settings) and initiate the onboarding process with Stripe. By clicking the corresponding button for your organization, an email will be sent with instructions to follow. If you don't complete this process, you won't be able to receive the mentioned compensation.</DimmedText>
