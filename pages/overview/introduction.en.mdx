...
The bot enables the use of different [commands](/overview/commands) directly integrated with GitHub to interact with the platform: create rewards, claim them, and more.
