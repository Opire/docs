...
<DimmedText>L' [application Opire](/overview/install-bot) permet à n'importe quel utilisateur d'utiliser les commandes Opire dans les dépôts où elle est installée, facilitant ainsi l'interaction avec la plateforme Opire sans quitter votre dépôt GitHub.</DimmedText>
<br/><br/>
